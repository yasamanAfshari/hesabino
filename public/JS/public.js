// ===== توابع مشترک بین صفحات؛ چون این فایل زودتر از اسکریپت‌های هر صفحه لود می‌شه
// (نگاه کن به main.ejs)، این توابع سراسری (global) در دسترس بقیه‌ی اسکریپت‌ها هم هستن =====
